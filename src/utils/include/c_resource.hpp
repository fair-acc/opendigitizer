...
private:
    ...
    static constexpr auto like(const c_resource &self) noexcept {
        return static_cast<const element_type>(self._element);
    }
...
public:
    ...
    struct guard {
        ...
        constexpr explicit guard(c_resource &Obj) noexcept
            : ptr_{ Obj._element } {}
