...
struct Acquisition {
    ...
    Annotated<std::vector<std::string>, opencmw::NoUnit, "TODO: add description">       acquisitionContextCol_eventName;
    Annotated<std::vector<int>, opencmw::NoUnit, "TODO: add description">               acquisitionContextCol_processIndex;
    Annotated<std::vector<int>, opencmw::NoUnit, "TODO: add description">               acquisitionContextCol_sequenceIndex;
    Annotated<std::vector<int>, opencmw::NoUnit, "TODO: add description">               acquisitionContextCol_chainIndex;
    Annotated<std::vector<int>, opencmw::NoUnit, "TODO: add description">               acquisitionContextCol_eventNumber;
    Annotated<std::vector<int>, opencmw::NoUnit, "TODO: add description">               acquisitionContextCol_timingGroupID;
    Annotated<std::vector<std::int64_t>, si::time<nanosecond>, "TODO: add description"> acquisitionContextCol_eventStamp;
    Annotated<std::vector<std::int64_t>, si::time<nanosecond>, "TODO: add description"> acquisitionContextCol_processStartStamp;
    Annotated<std::vector<std::int64_t>, si::time<nanosecond>, "TODO: add description"> acquisitionContextCol_sequenceStartStamp;
    Annotated<std::vector<std::int64_t>, si::time<nanosecond>, "TODO: add description"> acquisitionContextCol_chainStartStamp;
    Annotated<std::vector<std::uint8_t>, opencmw::NoUnit, "TODO: add description">      acquisitionContextCol_eventFlags;
    Annotated<std::vector<std::int16_t>, opencmw::NoUnit, "TODO: add description">      acquisitionContextCol_reserved;
    Annotated<std::vector<std::int64_t>, opencmw::NoUnit, "TODO: add description">      acquisitionContextCol_event_id_raw;
    Annotated<std::vector<std::int64_t>, opencmw::NoUnit, "TODO: add description">      acquisitionContextCol_param_raw;
    Annotated<int, opencmw::NoUnit, "TODO: add description">                            processIndex       = 0;
    Annotated<int, opencmw::NoUnit, "TODO: add description">                            sequenceIndex      = 0;
    Annotated<int, opencmw::NoUnit, "TODO: add description">                            chainIndex         = 0;
    Annotated<int, opencmw::NoUnit, "TODO: add description">                            eventNumber        = 0;
    Annotated<int, opencmw::NoUnit, "TODO: add description">                            timingGroupID      = 0;
    Annotated<std::int64_t, si::time<nanosecond>, "TODO: add description">              acquisitionStamp   = 0;
    Annotated<std::int64_t, si::time<nanosecond>, "TODO: add description">              eventStamp         = 0;
    Annotated<std::int64_t, si::time<nanosecond>, "TODO: add description">              processStartStamp  = 0;
    Annotated<std::int64_t, si::time<nanosecond>, "TODO: add description">              sequenceStartStamp = 0;
    Annotated<std::int64_t, si::time<nanosecond>, "TODO: add description">              chainStartStamp    = 0;
