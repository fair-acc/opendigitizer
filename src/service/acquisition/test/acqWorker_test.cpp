...
const boost::ut::suite basic_acq_worker_tests = [] {
    ...
    "GetDataTest"_test = [] {
        ...
        client.unsubscribe(URI("mds://127.0.0.1:12345/DeviceName/Acquisition?signalFilter=A"));
        client.unsubscribe(URI("mds://127.0.0.1:12345/DeviceName/Acquisition?signalFilter=A,B"));
